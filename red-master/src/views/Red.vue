<template>
  <div id="app"
    ...
    <div class="header">
      ...
      <div class="logo">
        <a href="#">
          <img :src="require('../assets/mypic/title.png')"
               alt="宠友"
               width="125"
               height="48">
        </a>
      ...
      <div class="header_search">
        <el-input placeholder="搜索宠友"
                  v-model="search_text">
          <el-button slot="append"
                     icon="el-icon-search"
                     @click="search_note"></el-button>
        </el-input>
      </div>
    </div>
        ...
        <el-menu class="aside_menu"
          ...
          <el-submenu index="/Red/Mine">
            ...
            <el-menu-item-group>
              ...
              <el-menu-item index="/Red/Mine/communication">
