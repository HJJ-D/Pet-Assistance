        ...
        <div>
          ...
          <div style="margin-top:30px;display:flex;justify-content:center;">
            <el-button type="primary"
                       plain
                       @click="CreateUser">注册</el-button>
            <el-button type="success"
                       plain
                       @click="gotoLogin">前往登录页</el-button>
...
export default {
  ...
  methods: {
    ...
    handleChange(value) {
      console.log(this.equipmentdistrict);
    },
    // 注册用户
    CreateUser() {
      this.$http({
        ...
        data: {
          //键值对
          userAppName: this.usernickname,
          petAssistanceUserId: crypto.randomUUID(),
          userPwd: this.encrypt(this.password),
          introduction: this.introduction,
          userPhoneNum: this.phone,
          userProvince: this.equipmentdistrict[0],
          userCity: this.equipmentdistrict[1],
          userArea: this.equipmentdistrict[2],
    ...
    //       this.headphoto = res.data.imageUrl;
    //     })
    //     .catch((response) => {
...
.login .asidePic {
  ...
  background-image: url("../../assets/mypic/dogaside.jpg");
